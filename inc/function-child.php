...
function velocitychild_theme_setup()
{
	...
	if (class_exists('Kirki')) :
		...
		$fieldiklan = [
			'iklan_header'  => [
				'label'			=> 'Iklan Header',
				'description'	=> 'Iklan sebelah logo 468x60',
			],
			'iklan_header_2'  => [
				'label'			=> 'Iklan Header 2',
				'description'	=> 'Iklan sebelah logo 800x100',
			],
			'iklan_home_1'  => [
				'label'			=> 'Iklan Home',
...
add_action('justg_after_header', 'justg_after_header_berita');
function justg_after_header_berita()
{
	echo '<div class="px-2">';
	echo '<div class="container px-0 bg-light mb-4 card-shadow">';
	get_template_part('partials/header', 'navbar');
	echo '<div class="px-2">';
}
add_action('justg_after_footer', 'justg_after_footer_berita');
function justg_after_footer_berita()
{
	echo '</div>';
	echo '</div>';
	echo '</div>';
...
function get_berita_iklan($idiklan,$class=null)
{
	$class = $class ? $class : 'mb-3 text-center';
	...
	if ($iklan_content) {
		...
		echo '<div class="'.$class.' position-relative">';
		echo $linkiklan ? '<a class="position-relative" href="' . $linkiklan . '" target="_blank">' : '';
